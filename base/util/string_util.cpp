...
std::wstring UTF8ToUTF16(const UTF8Char *utf8, size_t length)
{
	...
	while (src_begin < src_end)
	{
        ...
        utf16.append(output, dst_begin - reinterpret_cast<UTF32 *>(output));
...
std::string UTF16ToUTF8(const UTF32Char *utf16, size_t length)
{
	UTF8Char output[8192];
    const UTF32 *src_begin = reinterpret_cast<const UTF32 *>(utf16);
